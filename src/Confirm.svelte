...
<div class="alert-toast fixed bottom-0 right-0 m-8 w-5/6 md:w-full max-w-sm">
    ...
    <label class="close cursor-pointer flex items-start font-bold font-mono justify-between w-full px-3 p-2 bg-green-600 rounded shadow-lg text-white" title="close" for="footertoast">
      Input text modified
